...
class UserController extends Controller {
    ...
    public function home() {
        ...
        return view($this->activeTemplate . 'user.dashboard', compact('pageTitle', 'emptyMessage', 'totalProduct','orders','order'));
    }
    ...
    public function paymentHistory() {
        ...
        $payments             = Transaction::where('user_id', Auth::id())->orderBy('id', 'desc')->paginate(getPaginate());
        $emptyMessage         = "Data not found";
        return view($this->activeTemplate . 'user.payment.history', compact('pageTitle', 'payments','emptyMessage'));
    }
