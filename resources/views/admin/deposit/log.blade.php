                    ...
                    <table class="table table--light style--two">
                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Gateway | Trx')">
                                    <span class="font-weight-bold"> <a href="{{ route('admin.orders.detail', @$deposit->order->id) }}">{{ __(@$deposit->order->order_no) }}</a> </span>
                               </td>
                                ...
                                <td data-label="@lang('User')">
                                    <span class="font-weight-bold">{{ $deposit->user->fullname ?? 'null user' }}</span>
                                    <br>
                                    <span class="small">
